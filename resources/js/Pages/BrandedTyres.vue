<template>
    <Head>
        <title>High Quality and Performant Tyres Available | ProntoTyres</title>
        <meta name="description" content="We stock high quality and performant tyres from the leading tyre manufacturers">
        <link rel="canonical" href="https://prontotyres.co.uk/branded-tyres">
    </Head>
        ...
        <div class="sm:px-0 px-4">
            ...
            <div class="md:grid grid-cols-12 gap-y-12 lg:gap-x-4 md:gap-x-8 md:space-y-0 space-y-12 md:mt-8 mt-4">
                <div class="col-span-7">
                    <p class="text-sm">
                        <b>ProntoTyres</b> branded tyres are the ideal choice for those who value safety, performance, and quality.
                    ...
                    <br>
                    <p class="text-sm">
                        With ProntoTyres, you can have peace of mind knowing that you're investing in high-quality tyres that will improve your vehicle's safety,
                        performance, and lifespan. So, for your next tyre change, why not go with branded tyres from ProntoTyres and see the difference that quality makes?
                    </p>
                </div>
