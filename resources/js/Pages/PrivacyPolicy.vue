<template>
    <Head>
        <title>Our Privacy Policy | ProntoTyres</title>
        <meta name="description" content="Our privacy policy">
        <link rel="canonical" href="https://prontotyres.co.uk/privacy-policy">
    </Head>
    ...
    <Container class="pt-8 pb-8 md:mb-16 mb-8 sm:mt-8 mt-4">
        <div class="sm:px-0 px-4">
            ...
            <p class="text-sm">
                ProntoTyres respects your privacy and is committed to protecting your personal data.
            ...
            <br>
            <p class="text-sm">
                ProntoTyres is the controller and responsible for your personal data.
            </p>
            <br>
            <p class="text-sm">
                If you have any questions about this privacy notice, please contact the data privacy manager here <a class="text-blue-600 underline" href="mailto:info@prontotyres.co.uk">info@prontotyres.co.uk</a>.
            </p>
